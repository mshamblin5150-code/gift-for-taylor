...
String? managerHandoverRefusalWording(Object? error) => switch (error) {
  ManagerHandoverRefused(:final reason) => switch (reason) {
    ...
    ManagerHandoverRefusal.successorAlreadyManager =>
      'Choose another Staff member because this person is already the Manager.',
    ManagerHandoverRefusal.successorNoCurrentSection =>
      'Assign this Staff member a current Section before transferring Manager.',
  },
  _ => null,
};
...
String? inviteAcceptanceRefusalWording(Object? error) => switch (error) {
  InviteAcceptanceRefused(:final reason) => switch (reason) {
    ...
    InviteAcceptanceRefusal.emailAcceptancePending =>
      'Ask the Manager or an Administrator to confirm the Invite this email '
          'already accepted.',
    InviteAcceptanceRefusal.accountMissingEmail =>
      'Sign out and use an account with an email address before accepting this '
          'Invite.',
  },
  _ => null,
};
