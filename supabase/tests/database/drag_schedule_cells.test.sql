...
values
  ...
  ('00000000-0000-0000-0000-000000000586', '00000000-0000-0000-0000-000000000583', 2, '2027-03-01');
...
select public.save_schedule_cell('00000000-0000-0000-0000-000000000586',
  '00000000-0000-0000-0000-000000000583', '2027-03-18', 'X');
...
select lives_ok($$
  select public.save_schedule_cell_pair(
    ...
    '00000000-0000-0000-0000-000000000586', '00000000-0000-0000-0000-000000000583', '2027-03-18', 'X', '7A')
...
select throws_ok($$
  select public.save_schedule_cell_pair(
    ...
    '00000000-0000-0000-0000-000000000586', '00000000-0000-0000-0000-000000000583', '2027-03-18', '7A', 'X')
